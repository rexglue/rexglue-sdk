...
constexpr auto kReXGlueVersion = rexglue::build::kVersionString;
...
bool RecompilerOutput::write_config_h(const std::filesystem::path& dir) {
  ...
  out << "#pragma once\n";
  out << "//=============================================================================\n";
  out << fmt::format("// ReXGlue v{} Generated - {} Configuration\n", kReXGlueVersion,
...
bool RecompilerOutput::write_shared_h(const std::filesystem::path& dir) {
  ...
  out << "#pragma once\n";
  out << "//=============================================================================\n";
  out << fmt::format("// ReXGlue v{} Generated - {} Function Declarations\n", kReXGlueVersion,
                     config_.project_name);
  out << "//=============================================================================\n\n";
...
bool RecompilerOutput::write_recomp_files(const std::filesystem::path& dir) {
  ...
  for (size_t file_idx = 0; file_idx < num_files; ++file_idx) {
    ...
    out << "//=============================================================================\n";
    out << fmt::format("// ReXGlue v{} Generated - {} Recompiled Functions (Part {})\n",
                       kReXGlueVersion, config_.project_name, file_idx);
    out << "//=============================================================================\n\n";
...
bool RecompilerOutput::write_init(const std::filesystem::path& dir) {
  ...
  out << "//=============================================================================\n";
  out << fmt::format("// ReXGlue v{} Generated - {} Function Mapping & Initialization\n",
                     kReXGlueVersion, config_.project_name);
...
bool RecompilerOutput::write_cmake(const std::filesystem::path& dir) {
  ...
  out << fmt::format(
      "# Generated by ReXGlue v{} - {} Recompiled Code Library\n", kReXGlueVersion,
      config_.project_name);
  out << "# \n";
