...
PPC_STUB_RETURN(__imp__IoDismountVolume, 0)
PPC_STUB_RETURN(__imp__IoInvalidDeviceRequest, 0)
PPC_STUB_RETURN(__imp__IoDeleteDevice, 0)
PPC_STUB_RETURN(__imp__IoCompleteRequest, 0)
PPC_STUB_RETURN(__imp__IoCheckShareAccess, 0)
PPC_STUB_RETURN(__imp__IoSetShareAccess, 0)
PPC_STUB_RETURN(__imp__IoRemoveShareAccess, 0)
